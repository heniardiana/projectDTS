...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>Vivace Photography</title>

    <!--====== FAVICON ICON =======-->
    <link rel="shortcut icon" type="image/ico" href="img/photography.jpg" />
...
<body data-spy="scroll" data-target=".mainmenu-area" data-offset="90">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="call-to-action">
                            <p><i class="fa fa-phone"></i> <a href="callto:+8801744430440">+62 896 7488 xxxx</a></p>
                            <p><i class="fa fa-envelope-o"></i> <a href="mailto:vivace_photography@gmail.com">vivace_photography@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><img src="img/photography.jpg" alt="logo" width="60" height="20"></a>
                        </div>
    ...
    <!--SERVICE TOP AREA-->
    <section class="service-top-area padding-100-50" id="service">
        <div class="container">
            <div class="row">
                <div align="center"><h1 align="center">SERVICE</h1></div><br />
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-service text-center wow fadeIn">
                        <div class="service-icon">
                            <div class="i fa fa-print"></div>
                        </div>
                        <h3>PRINTING</h3>
                        <p>Kami menerima order Cetak photo baik dari HP ataupun media lainnya sampai dengan ukuran 24RP (60×90), tersedia juga berbagai jenis frame baik ukir ataupun fiber polos sesuai selera.</p>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-service text-center wow fadeIn">
                        <div class="service-icon">
                            <div class="i fa fa-photo"></div>
                        </div>
                        <h3>PHOTO BOOTH</h3>
                        <p>Ingin memberikan souvenir istimewa kepada tamu undangan anda? photobooth adalah jawabannya, harga terjangkau dan bisa disesuaikan untuk jumlah tamu yang hadir dengan paket yang ada.</p>
                        <a href="#" class="read-more">Learn More</a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="single-service text-center wow fadeIn">
                        ...
                        <h3>EDITING</h3>
                        <p>Punya photo atau video yang ingin di edit atau di edit ulang? silahkan hubungi kami untuk jasa photo atau video editing. Melayani juga order dari luar kota via media online.</p>
                        <a href="#" class="read-more">Learn More</a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-service text-center wow fadeIn">
                        <div class="service-icon">
                            <div class="i fa fa-video-camera"></div>
                        </div>
                        <h3>VIDEOGRAHPY SRVICE</h3>
                        <p>Punya photo atau video yang ingin di edit atau di edit ulang? silahkan hubungi kami untuk jasa photo atau video editing. Melayani juga order dari luar kota via media online.</p>
                        <a href="#" class="read-more">Learn More</a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-service text-center wow fadeIn">
                        ...
                        <h3>PHOTO STUDIO</h3>
                        <p>Melayani Jasa Photo Studio seperti Pas Photo, Photo Gaya, Photo Konsep, Photo Grup, Photo Keluarga, Photo Couple, Photo Anak, Photo Produk, Photo Katalog, PreWedding Indoor, Digital Imaging, dll.</p>
                        <a href="#" class="read-more">Learn More</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="portfolio-menu-content wow fadeIn">
                        <ul class="portfolio-menu">
                            ...
                            <li data-filter=".booth">Photo Booth</li>
                            <li data-filter=".editing">Editing</li>
                            <li data-filter=".photography">Photography Service</li>
                            <li data-filter=".videography">Videography Service </li>
                            <li data-filter=".studio">Photo Studio</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row portfolio-list wow fadeIn">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 printing portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/ph1.jpg" alt="" width="1600" height="900">
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 booth portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/pb1.jpg" alt="" >
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Photo Booth</h4>
                            <p>Business / Service / Product / Template</p>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 editing portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/ep1.jpg" alt="" width="460" height="332">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Editing</h4>
                            <p>Business / Service / Product / Template</p>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 photography portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/ps1.jpg" alt="" width="460" height="332">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Photography Sevice</h4>
                            <p>Business / Service / Product / Template</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 videography portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/vs1.jpg" alt="" width="460" height="332">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Videography Service</h4>
                            <p>Business / Service / Product / Template</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 studio portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="img/portfolio/sp1.jpg" alt="" width="460" height="332">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Photo Studio</h4>
                            <p>Business / Service / Product / Template</p>
                ...
                <div class="row">
                        ...
                        <div class="contact-details-content wow fadeIn">
                            ...
                            <div class="contact-address-details">
                                ...
                                <div class="single-contact">
                                    ...
                                    <div class="contact-details">
                                        <h5>Email</h5>
                                        <p>vivacephotography@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="contact-form mb50 wow fadeIn">
                            <h2>Send Message</h2>
                            <form action="../komentar.php" id="contact-form" method="post">
                                <div class="form-group" id="name-field">
                                    <div class="form-input">
                                        <input type="text" class="form-control" id="form-name" name="nama" placeholder="Name..">
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="message-field">
                                    <div class="form-input">
                                        <textarea class="form-control" rows="6" id="form-message" name="pesan" placeholder="Your Message Here..." ></textarea>
                                    </div>
                                </div>
